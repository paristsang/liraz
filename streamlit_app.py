...
FEATURE_FR_CLASSES: Dict[str, List[Tuple[str, float]]] = {
    ...
    # Aspect -> fr_asp
    "fr_asp": [
        ("North (0–22.5, 337.5–360)", 0.1601),
        ("Northeast (22.5–67.5)", 0.1520),
        ("East (67.5–112.5)", 0.1316),
        ("Southeast (112.5–157.5)", 0.1129),
        ("South (157.5–202.5)", 0.1016),
        ("Southwest (202.5–247.5)", 0.0796),
        ("West (247.5–292.5)", 0.1058),
        ("Northwest (292.5–337.5)", 0.1564),
        ("Flat / No aspect", 0.0000),
    ],
    ...
    # Land use -> fr_land
    "fr_land": [
        ("Artificial surfaces", 0.0942),
        ("Agricultural areas", 0.4777),
        ("Forest & semi-natural", 0.2339),
        ("Wetlands", 0.0000),
        ("Water bodies", 0.1942),
    ],
    ...
    "fr_road": [
        ("< 100m", 0.110768893),
        ("100–200m", 0.185879598),
        ("200–300m", 0.227070635),
        ("300–400m", 0.278489831),
        ("> 400m", 0.197791042),
    ],
...
FEATURE_LABELS: Dict[str, str] = {
    ...
    "fr_slop": "Slope",
    "fr_asp":  "Aspect",
    "fr_river":"Distance to River network",
